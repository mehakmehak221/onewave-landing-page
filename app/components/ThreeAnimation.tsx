...
const RotatingLogo = ({ isMobile, isTablet }: { isMobile: boolean; isTablet: boolean }) => {
...
const ComingSoonText = ({ isMobile, isTablet }: { isMobile: boolean; isTablet: boolean }) => {
...
const ParticleRing = ({ isMobile, isTablet }: { isMobile: boolean; isTablet: boolean }) => {
...
const ResponsiveCamera = ({ isMobile, isTablet }: { isMobile: boolean; isTablet: boolean }) => {
